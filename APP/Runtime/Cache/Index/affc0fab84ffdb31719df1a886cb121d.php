...
<div class="template">
  <div class="box">
    <h3><p><span>置顶</span>文章 Top</p></h3>
    <ul>
      <?php if(is_array($zd)): foreach($zd as $key=>$v): ?><li><a href="<?php echo U('article/'.$v['id']);?>" title="<?php echo ($v["title"]); ?>" ><img src="<?php echo ($v["coverpic"]); ?>" alt="<?php echo ($v["title"]); ?>"></a><span><?php echo ($v["title"]); ?></span></li><?php endforeach; endif; ?>
    </ul>
  </div>
</div>
<article>
...
<div class="guanzhu">扫描二维码关注<span>小浪花微信~</span>目前是单身啦</div>   
