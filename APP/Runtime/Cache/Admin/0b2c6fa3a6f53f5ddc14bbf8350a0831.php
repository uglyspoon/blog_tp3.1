...
<body>
<!-- content start -->
<form class="am-form" action="<?php echo U(GROUP_NAME.'/Category/addCateHandle');?>" method="post">
  <div class="admin-content-body">
    ...
    <div class="am-tabs am-margin" data-am-tabs>
      <ul class="am-tabs-nav am-nav am-nav-tabs">
        <li class="am-active"><a href="#tab1">新增首页分类</a></li>
      </ul>
      <div class="am-tabs-bd">
        <div class="am-tab-panel am-fade am-in am-active" id="tab1">
          
            <div class="am-g am-margin-top-sm">
              <div class="am-u-sm-4 am-u-md-2 am-text-right"> 分类栏目名称: </div>
            ...
            <div class="am-g am-margin-top-sm">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end">
                <input type="text" name="sort" class="am-input-sm" value="100">
              </div>
            </div>
            <div class="am-g am-margin-top-sm">
              <div class="am-u-sm-4 am-u-md-2 am-text-right"> 栏目描述 </div>
              <div class="am-u-sm-8 am-u-md-4 am-u-end">
