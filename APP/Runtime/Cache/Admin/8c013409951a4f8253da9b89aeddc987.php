...
<div class="admin-content">
  <div class="admin-content-body">
    <div class="am-cf am-padding am-padding-bottom-0">
      <div class="am-fl am-cf"> <strong class="am-text-primary am-text-lg">RBAC</strong> / <small>添加<?php echo ($type); ?></small> </div>
    </div>
    <hr>
    <form class="am-form" action="<?php echo U(GROUP_NAME.'/RBAC/addNodehandle');?>" method="post">
    <div class="am-tabs am-margin" data-am-tabs>
      <ul class="am-tabs-nav am-nav am-nav-tabs">
        <li class="am-active"><a href="#tab1">填写<?php echo ($type); ?>信息</a></li>
      </ul>
      <div class="am-tabs-bd">
        <div class="am-tab-panel am-fade am-in am-active" id="tab1">
            <div class="am-g am-margin-top-sm">
              <div class="am-u-sm-4 am-u-md-2 am-text-right"> <?php echo ($type); ?>名称(英文): </div>
              <div class="am-u-sm-8 am-u-md-4 am-u-end">
                <input type="text" name="name" class="am-input-sm">
             </div>
            </div>
            <div class="am-g am-margin-top-sm">
              <div class="am-u-sm-4 am-u-md-2 am-text-right"> <?php echo ($type); ?>描述(中文): </div>
              <div class="am-u-sm-8 am-u-md-4 am-u-end">
    	...
    	<div class="am-g am-margin-top-sm">
            ...
            <div class="am-g am-margin-top-sm">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end">
                <input type="text" name="sort" value='1' class="am-input-sm">
             </div>
